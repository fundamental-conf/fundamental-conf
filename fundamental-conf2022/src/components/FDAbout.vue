  ...
  <section class="fd-about" id="about">
    <div class="fd-about__container">
      ...
      <div class="fd-about__content">
        <h2>join the innovation</h2>
        <p>
          On September 29th, Fundamental Conference is coming back for the
          second time with an all-new one-day worldwide virtual event where
          designers and developers come together to share ideas and innovative
          practices that drive the future of front-end at SAP.
          <a
            class="fd-about__agenda"
            target="_blank"
            rel="noreferrer"
            href="https://www.youtube.com/watch?v=hU_lCVbGIXU&list=PLChUxte5emJatZ4s96DLhPE3LlVjbl2Au"
            aria-label="Link to Fundamental Library's agenda youtube link"
          >
            <svg
              width="24"
              height="24"
            ...
            >
              ...
              />
              <path
                d="M10.1139 8.72356L14.8778 11.1055C15.6149 11.4741 15.6149 12.5259 14.8778 12.8944L10.1139 15.2763C9.44897 15.6088 8.66666 15.1253 8.66666 14.3819V9.61799C8.66666 8.87461 9.44897 8.39111 10.1139 8.72356Z"
                fill="currentColor"
              />
            </svg>
